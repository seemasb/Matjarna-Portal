...
export const activateUser = async (id: any) => {
  try {
    const response = await commInstance.patch(
      `/api/private/user/${id}/activate`
    );
    return response;
  } catch (error) {
    return error;
...
export const deactivateUser = async (id: any) => {
  try {
    const response = await commInstance.patch(
      `/api/private/user/${id}/deactivate`
    );
    return response;
  } catch (error) {
    return error;
...
export const getUserInfo = async (): Promise<any> => {
  try {
    const response = await commInstance.get("/api/private/user");
    return response;
  } catch (error: any) {
    return error;
  }
